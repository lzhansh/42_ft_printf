...
/*   Updated: 2019/06/27 20:06:09 by lzhansha         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_print_digits_width(t_list *env)
{
	...
	i = -1;
	len = ((int)ft_strlen(env->out) > env->flag.prec ? ft_strlen(env->out) :
	env->flag.prec);
	(env->flag.neg || env->flag.plus || env->flag.sp) ? env->flag.width-- : 0;
	if (env->flag.prec >= 0)
	{
